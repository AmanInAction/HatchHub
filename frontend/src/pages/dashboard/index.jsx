...
function Dashboard() {
  ...
  useEffect(() => {
    dispatch(getAllPosts()); // 👈 make sure this is being called
  }, [dispatch]);
                      ...
                      <div className={styles.singleCard}>
                        <div className={styles.singleCard_profileContainer}>
                          ...
                          <div>
                            ...
                            <p style={{ color: "gray", paddingTop: "1.2rem" }}>
                              {post.body}
                            </p>
                    ...
                    {postState.comments.map((postComment, index) => {
                      return (
                        ...
                        >
                          ...
                          >
                            <img
                              src={`${process.env.NEXT_PUBLIC_SERVER_URL}/${postComment.userID.profilePicture}`}
                              alt=""
                            />
                            <p
